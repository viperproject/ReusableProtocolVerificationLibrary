...
additionalGobraArgs="--module github.com/ModularVerification/ReusableVerificationLibrary --z3Exe /Users/arquintlinard/Downloads/z3-4.8.7-x64-osx-10.14.6/bin/z3"

if [ $isCi ]; then
    echo -e "\033[0Ksection_start:`date +%s`:verify[collapsed=true]\r\033[0KVerifying packages"
fi
java -Xss128m -jar $gobraJar --recursive -I $scriptDir $additionalGobraArgs # --printVpr --includePackages tracemanager # --unparse --parseOnly
exitCode=$?
if [ $isCi ]; then
