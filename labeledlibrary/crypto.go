...
func (l *LabeledLibrary) GeneratePkeKey( /*@ ghost usageString string @*/ ) (pk, sk lib.ByteString, err error /*@, ghost skT tm.Term @*/) {
...
func (l *LabeledLibrary) GenerateSigningKey( /*@ ghost usageString string @*/ ) (pk, sk lib.ByteString, err error /*@, ghost skT tm.Term @*/) {
	//@ ownerWoThread := l.OwnerWoThread()
	//@ unfold l.Mem()
	//@ keyLabel := label.Readers(set[p.Id]{ ownerWoThread })
